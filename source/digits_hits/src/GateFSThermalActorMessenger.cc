...
#ifndef GATEFSTHERMALACTORMESSENGER_CC
#define GATEFSTHERMALACTORMESSENGER_CC
...
//-----------------------------------------------------------------------------
GateFSThermalActorMessenger::GateFSThermalActorMessenger(GateFSThermalActor* sensor)
...
//-----------------------------------------------------------------------------
GateFSThermalActorMessenger::~GateFSThermalActorMessenger()
{
...
//-----------------------------------------------------------------------------
void GateFSThermalActorMessenger::SetNewValue(G4UIcommand* cmd, G4String newValue)
{
